...
CC= gcc
CFLAGS= -g -fPIC -ansi -Wall -pedantic
LDFLAGS=
...
libjazz: src/lex.o src/string.o src/y.tab.o src/vm.o src/compile.o
...
src/compile.o: src/compile.c src/compile.h src/parse.h src/opcode.h
